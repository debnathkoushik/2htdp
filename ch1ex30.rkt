...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ch1ex30) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; currentTicketPrice has no use in this function definition, but for the sake of passing argument to a function
(define(priceSensitivity currentTicketPrice) (/ affectedAttendance changeInTicketPrice))

(define (attendance currentTicketPrice)
  (+ oriAttendance (* (- oriTicketPrice currentTicketPrice) (priceSensitivity currentTicketPrice))))
